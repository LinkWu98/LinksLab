...
public class SalesOrdersDTO implements Serializable {
    ...
    public String toString() {
        return "SalesOrdersDTO{" +
                ...
                ", sheetCreateDate=" + sheetCreateDate +
                ", sheetCreatedBy='" + sheetCreatedBy + '\'' +
                ...
                ", auditedManager='" + auditedManager + '\'' +
                ", auditedByManagerDate=" + auditedByManagerDate +
                ", confirmedDate=" + confirmedDate +
                ", auditedManagerRemark='" + auditedManagerRemark + '\'' +
                ", deliveryMode=" + deliveryMode +
                ", invoiceMode=" + invoiceMode +
                ", handCarStatus=" + handCarStatus +
                ", isClearing=" + isClearing +
                ", submitTime=" + submitTime +
                ", whetherToReplace=" + whetherToReplace +
                ", isOurStore=" + isOurStore +
                ", isDeposit=" + isDeposit +
                ", remark='" + remark + '\'' +
